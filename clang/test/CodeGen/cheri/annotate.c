...
// CHECK-NEXT:    call void @llvm.var.annotation.p200(ptr addrspace(200) [[B]], ptr addrspace(200) @.str.3, ptr addrspace(200) @.str.1, i32 51, ptr addrspace(200) null)
// CHECK-NEXT:    ret void
//
// HYBRID-LABEL: @var_annotation(
// HYBRID-NEXT:  entry:
// HYBRID-NEXT:    [[B:%.*]] = alloca i32, align 4
// HYBRID-NEXT:    call void @llvm.var.annotation.p0(ptr [[B]], ptr @.str.3, ptr @.str.1, i32 51, ptr null)
// HYBRID-NEXT:    ret void
//
...
// CHECK-NEXT:    [[TMP0:%.*]] = call ptr addrspace(200) @llvm.ptr.annotation.p200.p200(ptr addrspace(200) [[V]], ptr addrspace(200) @.str.4, ptr addrspace(200) @.str.1, i32 93, ptr addrspace(200) null)
...
// HYBRID-NEXT:    [[TMP0:%.*]] = call ptr @llvm.ptr.annotation.p0.p0(ptr [[V]], ptr @.str.4, ptr @.str.1, i32 93, ptr null)
...
// CHECK-NEXT:    [[TMP1:%.*]] = call i64 @llvm.annotation.i64.p200(i64 [[TMP0]], ptr addrspace(200) @.str.5, ptr addrspace(200) @.str.1, i32 139)
...
// HYBRID-NEXT:    [[TMP1:%.*]] = call i64 @llvm.annotation.i64.p0(i64 [[TMP0]], ptr @.str.5, ptr @.str.1, i32 139)
...
// CHECK-NEXT:    [[TMP1:%.*]] = call ptr addrspace(200) @llvm.ptr.annotation.p200.p200(ptr addrspace(200) [[U]], ptr addrspace(200) @.str.4, ptr addrspace(200) @.str.1, i32 150, ptr addrspace(200) null)
...
// CHECK-NEXT:    [[TMP4:%.*]] = call ptr addrspace(200) @llvm.ptr.annotation.p200.p200(ptr addrspace(200) [[U1]], ptr addrspace(200) @.str.4, ptr addrspace(200) @.str.1, i32 150, ptr addrspace(200) null)
...
// HYBRID-NEXT:    [[TMP1:%.*]] = call ptr addrspace(200) @llvm.ptr.annotation.p200.p0(ptr addrspace(200) [[U]], ptr @.str.4, ptr @.str.1, i32 150, ptr null)
...
// HYBRID-NEXT:    [[TMP4:%.*]] = call ptr addrspace(200) @llvm.ptr.annotation.p200.p0(ptr addrspace(200) [[U1]], ptr @.str.4, ptr @.str.1, i32 150, ptr null)

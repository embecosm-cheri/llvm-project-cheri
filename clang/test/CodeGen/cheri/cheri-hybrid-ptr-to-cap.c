...
// CHECK-LABEL: @global_data_to_cap(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @fn_ptr_to_cap_not_smart_enough(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[FN_PTR_ADDR:%.*]] = alloca ptr, align 8

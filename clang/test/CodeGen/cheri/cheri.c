...
// PTRS: ret void
// PTRS: define dso_local void @cheri_type_check(ptr nocapture noundef{{( %.+)?}}, ptr nocapture noundef
// PTRS: ret void
...
// CAPS: define dso_local void @cheri_type_check(ptr addrspace(200) noundef{{( %.+)?}}, ptr addrspace(200) noundef

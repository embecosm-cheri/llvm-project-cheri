...
// FIXME-HYBRID-NEXT: @global_cap_data_addr_uintcap = global ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 ptrtoint (ptr @extern_data to i64)), align 16
// HYBRID-NEXT: @global_cap_data_addr_uintcap = global ptr addrspace(200) addrspacecast (ptr @extern_data to ptr addrspace(200)), align 16
// PURECAP-NEXT: @global_cap_data_addr_uintcap = addrspace(200) global ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 ptrtoint (ptr addrspace(200) @extern_data to i64)), align 16
...
// HYBRID-NEXT: @global_cap_data_addr_uintcap_src_is_cap = global ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 ptrtoint (ptr @extern_data to i64)), align 16
// PURECAP-NEXT: @global_cap_data_addr_uintcap_src_is_cap = addrspace(200) global ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 ptrtoint (ptr addrspace(200) @extern_data to i64)), align 16
...
// HYBRID-NEXT: @global_fncap_addr = global ptr addrspace(200) addrspacecast (ptr @extern_fn to ptr addrspace(200)), align 16
// PURECAP-NEXT: @global_fncap_addr = addrspace(200) global ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 ptrtoint (ptr addrspace(200) @extern_fn to i64)), align 16
...
// HYBRID-NEXT: @global_intcap_data_addr_cast_intcap = global ptr addrspace(200) addrspacecast (ptr @extern_data to ptr addrspace(200)), align 16
// PURECAP-NEXT: @global_intcap_data_addr_cast_intcap = addrspace(200) global ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 ptrtoint (ptr addrspace(200) @extern_data to i64)), align 16
...
// FIXME: this should be null-derived in hybrid mode
// HYBRID-NEXT: @global_intcap_data_one_past_end_addr_cast_intcap = global ptr addrspace(200) addrspacecast (ptr getelementptr inbounds (i8, ptr @extern_data, i64 1) to ptr addrspace(200)), align 16
// PURECAP-NEXT: @global_intcap_data_one_past_end_addr_cast_intcap = addrspace(200) global ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 ptrtoint (ptr addrspace(200) getelementptr inbounds (i8, ptr addrspace(200) @extern_data, i64 1) to i64)), align 16
...
// FIXME: this should be null-derived in hybrid mode
// HYBRID-NEXT: @global_intcap_data_plus_two_addr_cast_intcap = global ptr addrspace(200) addrspacecast (ptr getelementptr (i8, ptr @extern_data, i64 2) to ptr addrspace(200)), align 16
// PURECAP-NEXT: @global_intcap_data_plus_two_addr_cast_intcap = addrspace(200) global ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 ptrtoint (ptr addrspace(200) getelementptr (i8, ptr addrspace(200) @extern_data, i64 2) to i64)), align 16
...
// HYBRID-NEXT: @global_intcap_fn_cast_addr = global ptr addrspace(200) addrspacecast (ptr @extern_fn to ptr addrspace(200)), align 16
// PURECAP-NEXT: @global_intcap_fn_cast_addr = addrspace(200) global ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 ptrtoint (ptr addrspace(200) @extern_fn to i64)), align 16
...
// HYBRID-NEXT: @global_intcap_fn_plus_two_intcap_addr_intcap = global ptr addrspace(200) addrspacecast (ptr getelementptr (i8, ptr @extern_fn, i64 2) to ptr addrspace(200)), align 16
// PURECAP-NEXT: @global_intcap_fn_plus_two_intcap_addr_intcap = addrspace(200) global ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 ptrtoint (ptr addrspace(200) getelementptr (i8, ptr addrspace(200) @extern_fn, i64 2) to i64)), align 16
...
// HYBRID-NEXT: @global_cap_data_addr_cast_intcap_one_past_end = global ptr addrspace(200) addrspacecast (ptr getelementptr inbounds (i8, ptr @extern_data, i64 1) to ptr addrspace(200)), align 16
// PURECAP-NEXT: @global_cap_data_addr_cast_intcap_one_past_end = addrspace(200) global ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 ptrtoint (ptr addrspace(200) getelementptr inbounds (i8, ptr addrspace(200) @extern_data, i64 1) to i64)), align 16

...
SDValue TargetLowering::CTTZTableLookup(SDNode *Node, SelectionDAG &DAG,
  ...
  Lookup = DAG.getSExtOrTrunc(Lookup, DL, getPointerTy(TD, TD.getGlobalsAddressSpace()));
  ...
  SDValue CPIdx = DAG.getConstantPool(CA, getPointerTy(TD, TD.getGlobalsAddressSpace()),

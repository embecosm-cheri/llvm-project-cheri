...
class AArch64SandboxMemOpLowering
  ...
  typedef enum { Invalid, MemCpy, MemPCpy, MemMove, MemSet } MemxferTy;
...
public:
  ...
  void replaceMemFun(Function &F) {
    ...
    if (MemCpy) {
      ...
      if (!Memcpy_c)
        Memcpy_c =
            M->getOrInsertFunction("memcpy_c", CapTy, CapTy, CapTy, Int64Ty);
    ...
    if (MemPCpy) {
      ...
      if (!Mempcpy_c)
        Mempcpy_c =
            M->getOrInsertFunction("mempcpy_c", CapTy, CapTy, CapTy, Int64Ty);
    ...
    if (MemSet) {
      ...
      if (!Memset_c)
        Memset_c =
            M->getOrInsertFunction("memset_c", CapTy, CapTy, Int32Ty, Int64Ty);
    ...
    if (MemMove) {
      ...
      if (!Memmove_c)
        Memmove_c =
            M->getOrInsertFunction("memmove_c", CapTy, CapTy, CapTy, Int64Ty);

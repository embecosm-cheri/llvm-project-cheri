...
declare i64 @llvm.annotation.i64.p0i8(i64, i8*, i8*, i32)
...
;
  %1 = tail call i64 @llvm.annotation.i64.p0i8(i64 %x, i8* null, i8* null, i32 0)
  ret i64 %1
}
...
;
  %1 = call i8* @llvm.ptr.annotation.p0i8.p0i8(i8* %x, i8* null, i8* null, i32 0, i8* null)
  ret i8* %1
}

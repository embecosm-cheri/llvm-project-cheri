...
; PURECAP-NEXT:    cincoffset cs1, csp, 0
; PURECAP-NEXT:    csetbounds ca1, cs1, 8
; PURECAP-NEXT:    csw a3, 4(cs1)
; PURECAP-NEXT:    csw a2, 0(csp)
...
; PURECAP-NEXT:    clw a1, 4(cs1)
; PURECAP-NEXT:    clw a2, 0(csp)

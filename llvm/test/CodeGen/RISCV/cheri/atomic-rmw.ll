...
; RV32IAXCHERI-NEXT:    csc cra, 56(csp) # 8-byte Folded Spill
; RV32IAXCHERI-NEXT:    csc cs0, 48(csp) # 8-byte Folded Spill
; RV32IAXCHERI-NEXT:    csc cs1, 40(csp) # 8-byte Folded Spill
; RV32IAXCHERI-NEXT:    csc cs2, 32(csp) # 8-byte Folded Spill
; RV32IAXCHERI-NEXT:    csc cs3, 24(csp) # 8-byte Folded Spill
; RV32IAXCHERI-NEXT:    csc cs4, 16(csp) # 8-byte Folded Spill
...
; RV32IAXCHERI-NEXT:    clw a5, 4(cs4)
...
; RV32IAXCHERI-NEXT:    clc cra, 56(csp) # 8-byte Folded Reload
; RV32IAXCHERI-NEXT:    clc cs0, 48(csp) # 8-byte Folded Reload
; RV32IAXCHERI-NEXT:    clc cs1, 40(csp) # 8-byte Folded Reload
; RV32IAXCHERI-NEXT:    clc cs2, 32(csp) # 8-byte Folded Reload
; RV32IAXCHERI-NEXT:    clc cs3, 24(csp) # 8-byte Folded Reload
; RV32IAXCHERI-NEXT:    clc cs4, 16(csp) # 8-byte Folded Reload
; RV32IAXCHERI-NEXT:    cincoffset csp, csp, 64
; RV32IAXCHERI-NEXT:    cret
;

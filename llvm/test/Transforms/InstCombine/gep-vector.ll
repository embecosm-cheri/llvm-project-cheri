...
; CHECK-NEXT:    [[ARR_PTR:%.*]] = bitcast <4 x i32>* [[X:%.*]] to [4 x i32]*
; CHECK-NEXT:    [[ASC:%.*]] = addrspacecast [4 x i32]* [[ARR_PTR]] to [4 x i32] addrspace(3)*
; CHECK-NEXT:    [[GEP:%.*]] = getelementptr [4 x i32], [4 x i32] addrspace(3)* [[ASC]], i64 [[Y:%.*]], i64 [[Z:%.*]]
; CHECK-NEXT:    ret i32 addrspace(3)* [[GEP]]
;
  %arr_ptr = bitcast <4 x i32>* %x to [4 x i32]*
...
; CHECK-NEXT:    [[ARR_PTR:%.*]] = bitcast <4 x i32>* [[X:%.*]] to [4 x i32]*
; CHECK-NEXT:    [[ASC:%.*]] = addrspacecast [4 x i32]* [[ARR_PTR]] to [4 x i32] addrspace(3)*
; CHECK-NEXT:    [[GEP:%.*]] = getelementptr inbounds [4 x i32], [4 x i32] addrspace(3)* [[ASC]], i64 [[Y:%.*]], i64 [[Z:%.*]]
; CHECK-NEXT:    ret i32 addrspace(3)* [[GEP]]
;
  %arr_ptr = bitcast <4 x i32>* %x to [4 x i32]*
  %asc = addrspacecast [4 x i32]* %arr_ptr to [4 x i32] addrspace(3)*
